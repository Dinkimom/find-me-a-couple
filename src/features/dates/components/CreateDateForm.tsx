...
export const CreateDateForm: React.FC = () => {
    const { opened, ...formState } = useSelector((state: RootState) => state.dates.createForm);
    const { receiver } = useSelector((state: RootState) => state.dates.createForm);
    ...
    return (
        <Modal
            ...
            destroyOnClose={true}
        >
            <BaseForm onSubmit={handleSubmit} {...formState} footer={null}>
                {receiver && (
...
CreateDateForm.displayName = 'CreateDateForm';

import { CalendarOutlined, CaretDownOutlined, LogoutOutlined, SearchOutlined, WechatOutlined } from '@ant-design/icons';
...
export const PageWrapper: React.FC<Props> = ({ children }) => {
    ...
    const PopoverContent = useMemo(() => {
        ...
        return (
            <div>
                <UpdateForm />
                <Button block onClick={handleLogout} type="text" icon={<LogoutOutlined />}>
                    Logout
                </Button>
            </div>
        );
    ...
    return (
        <Layout className={styles.layout}>
            ...
            <div className={styles.content}>
                <Menu mode="inline" className={styles.navigation} selectedKeys={[window.location.pathname]}>
                    <Menu.Item
                        key={PATHS.HOME}
